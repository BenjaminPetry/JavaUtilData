...
/**
 * Configuration file for a hibernate session. To use this class, inherit from
 * it, override the constructor and add the annotated hibernate classes with
 * addClass();
 *
...
public class HibernateConfig
{
     ...
     */
    public HibernateConfig(String type, String host, String user,
    ...
    {
        this(c.get(CONFIG_TYPE), c.get(CONFIG_HOST), c.get(CONFIG_USER), c.get(
                CONFIG_PASSWORD), c.get(CONFIG_DBNAME));
    }
