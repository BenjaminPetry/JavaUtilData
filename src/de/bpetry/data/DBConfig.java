...
import de.bpetry.file.ResourceManager;
import de.bpetry.util.Config;
...
public class DBConfig
{
    ...
    //-------------------------------------------------------------------------
    /**
     * Creates the login information for a database (assumes a LOCAL MySQL
     * database, no table prefix and the database name to be equal to the
     * username)
     *
     ...
     * no table prefix and the database name to be equal to the username)
     *
     ...
     *
     * @param type the type of the database (see DataSinkFactor for more
     * details)
     * @param host the IP of the host
     * @param user the username to login
     * @param password the password according to the username
     ...
     * @param prefix the prefix of all tables
     */
    public DBConfig(String type, String host, String user, String password,
            String dbname, String prefix)
    {
        this.type = type;
        this.host = host;
        this.user = user;
    ...
    public static DBConfig fromConfig(Config c, String initFilename)
    {
        ...
        DBConfig config = new DBConfig(type, host, user, password, dbname,
                prefix);
